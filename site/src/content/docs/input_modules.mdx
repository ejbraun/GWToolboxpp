...
### Settings:
- Enable cursor fix: Prevents queued cursor-warp movement from jerking the camera while preserving normal camera sensitivity, including Windows pointer speed and acceleration. Normal pointer movement is unchanged.
